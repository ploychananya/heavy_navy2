...
public class FreezBullet extends FreezTube {
	private World world;
	...
	private int damage;
	private float SPEED_Mons;
	private double SPEED_People;
	public FreezBullet(int x, int y, float angle,int damage, World world) {
